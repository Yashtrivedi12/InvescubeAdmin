...
class InvestmentHistoryTable extends StatefulWidget {
  @override
  State<InvestmentHistoryTable> createState() => _InvestmentHistoryTableState();
}

class _InvestmentHistoryTableState extends State<InvestmentHistoryTable> {
  ...
  Future<void> fetchDataFromApi() async {
    var url = Uri.parse(
        'https://admin.invescube.com/admin_api/show_investment_history.php');
                  ...
                  itemBuilder: (context, index) {
                    if (index == paginatedData.length) {
                      ...
                      return CustomTableRow(index, paginatedData[index],
                          deleteTableItem, dataList[index]);
                    }
                  },
                ),
              ),
...
class CustomTableRow extends StatefulWidget {
  ...
  CustomTableRow(
      this.index, this.rowData, this.deleteTableItem, this.additionalData);
